...
Draft an 8-ticket Melate system by pooling unique tickets from multi-seed strategy runs and/or exported system files, then greedily selecting by train objective for freeze-policy comparison.
